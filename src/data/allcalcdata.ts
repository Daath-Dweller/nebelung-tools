...
export const conversions: { [unit: string]: { factor: number, category: string, kommastellen?: number, displayName?: string } } = {
    ...
    giraffe: { factor: 0.25, category: 'length', kommastellen: 1, displayName: "Giraffe (Ø-Höhe)" },
    gruene_anakonda: { factor: 0.2, category: 'length', kommastellen: 1, displayName: "Gr. Anakonda (Ø)" },
    afrikanischer_elefant: { factor: 0.1, category: 'length', kommastellen: 1, displayName: "Afr. Elefant (Ø-Höhe)" },
    strauss: { factor: 0.4, category: 'length', kommastellen: 1, displayName: "Afr. Strauß (Ø-Höhe)" },
    leistenkrokodil: { factor: 0.125, category: 'length', kommastellen: 1, displayName: "Leistenkrokodil (Ø)" },
