...
export const conversions: { [unit: string]: { factor: number, category: string, kommastellen?: number, displayName?: string } } = {
    ...
    kilometer: { factor: 0.001, category: 'length', kommastellen: 2, displayName: "Kilometer" },
    ...
    mile: { factor: 0.000621371, category: 'length', kommastellen: 2, displayName: "Meile" },
    nautische_meile: { factor: 0.000539957, category: 'length', kommastellen: 2, displayName: "Nautische Meile" },
